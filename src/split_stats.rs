...
//         }
//
//         weakened_stats = weaken_split(num_records_in_total, &the_stats.0, &the_stats.1);
//
//         num_removals += 1;
//     };
//
...
//                 }
//
//                 champion_stats.update_score(num_records_in_total);
//                 runnerup_stats.update_score(num_records_in_total);
//
